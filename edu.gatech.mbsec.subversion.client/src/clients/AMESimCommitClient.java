...
public class AMESimCommitClient {

	public static <V> void main(String[] args) {
		try {

//			String workingCopyPath = "C:\\Users\\Axel\\Desktop\\myhttpswk\\myrepo3";
			String workingCopyPath = "C:\\apps\\csvn\\svn amesim working copy";
			String repositoryurl = "https://wdxcnd519309s.com/svn/amesimrepository";
...
//			svnScheduleForAddition.setSingleTarget(SvnTarget.fromFile(new File(workingCopyDirectory + "/model12.slx")));
