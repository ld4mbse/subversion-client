...
public class SubversionFileClientNoLoginDialog {

	static SVNRepository repository;
	static String repositoryurl = "https://koneksys1:18080/svn/myrepo";
	...
	static String workingCopyPath = "C:\\Users\\Axel\\Desktop\\myhttpswk\\myrepo4";
	...
	public static FileMetadata connectWithRepo() {
...
//			}
	...
	public static FileMetadata connectWithRepo(String username, String password) {
		FileMetadata fileMetadata = null;
		try {
			 UserLoginInfo userLoginInfo = new UserLoginInfo();
...
//			}
	...
	private static FileMetadata deleteFileAndPerformCheckout() {
		new File(workingCopyPath + "/" + fileName).delete();
		return performCheckout();
	}

	private static FileMetadata performUpdate() {
	...
	public static FileMetadata syncFile(String repositoryurl2, String workingCopyPath2) {
	...
	public static FileMetadata syncFile(String repositoryurl2, String workingCopyPath2, String username, String password) {
		// get repository directory
		String[] repParts = repositoryurl2.split("/");
		fileName = repParts[repParts.length - 1];
		repositoryurl = repositoryurl2.replace(fileName, "");
	...
	public static FileMetadata performCheckout() {
	...
	private static FileMetadata retrieveFileMetadata() {
	...
	public static void createLoginDialog() {
		...
		LoginDialog loginDlg = new SubversionFileClientNoLoginDialog().new LoginDialog(frame);
	...
	public static void createLoginDialog2() {

		final JFrame frame = new JFrame("Subversion Authentication");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		LoginDialog2 loginDlg = new SubversionFileClientNoLoginDialog().new LoginDialog2(frame);
		loginDlg.setVisible(true);
		wasLoginSuccesful = loginDlg.succeeded;
		frame.setSize(300, 100);
		frame.setLayout(new FlowLayout());
	...
	public class LoginDialog2 extends JDialog {
		...
		public void processLoginAttempt(JFrame parent) {
			...
			userLoginInfo.setPassword(getPassword());
			try {
				connectionStatus = SubversionFileClientNoLoginDialog.svnAuthentication(repositoryurl, userLoginInfo);
				if (connectionStatus.equals("ok")) {
	...
	public static String svnAuthentication(String svnLocation, UserLoginInfo userLoginInfo)
			throws SVNException {
