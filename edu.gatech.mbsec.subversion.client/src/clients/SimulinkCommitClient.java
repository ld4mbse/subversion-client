...
public class SimulinkCommitClient {

	public static <V> void main(String[] args) {
		try {

//			String workingCopyPath = "C:\\Users\\Axel\\Desktop\\myhttpswk\\myrepo3";
//			String workingCopyPath = "C:\\Users\\Axel\\Desktop\\mytestwk";
			String workingCopyPath = "C:\\Users\\Axel\\Desktop\\mytestwk3";
			
//			String repositoryurl = "https://Axel-PC/svn/simulinkrepository";
...
//			svnScheduleForAddition.setSingleTarget(SvnTarget.fromFile(new File(workingCopyDirectory + "/fssfsf15.txt")));
//			svnScheduleForAddition.run();
//			
//			SvnScheduleForRemoval svnScheduleForRemoval = svnOperationFactory.createScheduleForRemoval();
//			svnScheduleForRemoval.setSingleTarget(SvnTarget.fromFile(new File(workingCopyDirectory + "/sldemo_househeat.slx")));
//			svnScheduleForRemoval.run();
			
//			SvnScheduleForAddition svnScheduleForAddition = svnOperationFactory.createScheduleForAddition();
//			svnScheduleForAddition.setSingleTarget(SvnTarget.fromFile(new File(workingCopyDirectory + "/sldemo_househeat.slx")));
//			svnScheduleForAddition.run();
//			
//			SvnScheduleForRemoval svnScheduleForRemoval = svnOperationFactory.createScheduleForRemoval();
//			svnScheduleForRemoval.setSingleTarget(SvnTarget.fromFile(new File(workingCopyDirectory + "/model12.slx")));
//			svnScheduleForRemoval.run();
		    ...
		    System.out.println(commitInfo.getErrorMessage());
